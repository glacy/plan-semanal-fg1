      ...
      <AnimatePresence>
        {(isOpen || isDesktop) && (
          <motion.div
            ...
            className={`rounded-xl border shadow-sm transition-colors duration-300 max-h-[calc(100vh-200px)] lg:max-h-[calc(100vh-120px)] overflow-y-auto custom-scrollbar lg:sticky lg:top-24 ${isDarkMode
          ...
          >
            ...
            <div className="space-y-1 px-2 pb-5" role="list">
              {weeks.map((week) => {
